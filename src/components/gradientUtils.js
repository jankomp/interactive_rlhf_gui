...
export function lineJoin(p0, p1, p2, p3, width) {
    ...
    if (p0) { // clip ad and dc using average of u01 and u12
      var u01 = perp(p0, p1), e1 = [p1[0] + u01[0] + u12[0], p1[1] + u01[1] + u12[1]];
      a = lineIntersect(p1, e1, a, b);
      d = lineIntersect(p1, e1, d, c);
    }
  
    if (p3) { // clip ab and dc using average of u12 and u23
      var u23 = perp(p2, p3), e2 = [p2[0] + u23[0] + u12[0], p2[1] + u23[1] + u12[1]];
      b = lineIntersect(p2, e2, a, b);
      c = lineIntersect(p2, e2, d, c);
    }
